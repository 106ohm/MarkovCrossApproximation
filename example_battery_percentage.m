...
save(strcat('case2_percentage_RR_nstates_',int2str(nstates),'_nt_',int2str(nt),'_np_', int2str(np),'.mat'), "RR");
...
saveas(f,strcat('case2_percentage_nstates_',int2str(nstates),'_nt_',int2str(nt),'_np_', int2str(np),'.png'));
